...
use gen_relocs::dylib::{DylibWriter, ElfWriterConfig, SymbolDesc};
use gen_relocs::Arch;
use std::path::Path;
...
fn main() -> anyhow::Result<()> {
    ...
    let writer = DylibWriter::new(Arch::X86_64);
    ...
    let writer = DylibWriter::with_config(Arch::Aarch64, custom_config);
    ...
    let symbols = vec![
        ...
        SymbolDesc::local_var("local_symbol", 2, 0x100),
    ];
